...
def YELLOW(text):
    return'\x1b[1;33;40m'+str(text)+'\x1b[0m'
def BlackBG(text):
...
class SmartTextAnalyzer():
    ...
    def MostFrequentWords(self,n=5,Unique=False):
        Target=self.uniqueWords if Unique else self.wordsCounts
...
if __name__=="__main__":
    ...
    # search=Report.searchText("earth")
    # Report.displaySearch(search)
    Report.replaceWords("earth","NOT_EARTH")
    Report.replaceWords("earth","NOT_EARTH")
    # print(Report.sentences)

    # print(Report.wordsCounts)
    # print("uniqueWords Count",Report.uniqueCount)
    # print("Total Words",Report.totalWords)
    # print(Report.UniqueFrequency(10))
